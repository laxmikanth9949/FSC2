...
sap.ui.define([
	...
	return BaseController.extend("sap.support.fsc2.controller.IncidentDetail", {
		...
		loadSnowEscalationData: function (sValue) {
			...
			var oDataService = {
				"sys_id": sValue,
				"sysparm_fields": "action_status,source_record.correlation_id,source_record.action_status,de_escalation_justification,escalation_justification,u_request_reason,u_escalation_type,source_record.description,source_record.sys_created_on,source_record.sys_created_by,u_request,source_record.account.number,assigned_to.name,assigned_to.email,u_expected_action,u_business_impact,source_record.number,source_record.u_responsible_party,u_responsible_party,state,source_record.short_description,source_record.business_impact,source_record.u_contract_type_list,source_record.priority,source_record.account.name,source_record.u_deployed_item.u_number,source_record.u_deployed_item.u_sid, requested_by.name,requested_by.employee_number,requested_by.department.name,number,u_short_description,active,number,u_bcp_correlation_id,sys_updated_by,escalation,sys_id,short_description,source_record.correlation_display,priority,source_record.state,source_record.u_app_component.u_name,source_record.assigned_to.user_name,source_record.assigned_to.name,source_record.assignment_group.name,u_last_user_updated_on,u_next_action_due"
			};
			$.ajax({
				method: "GET",
				data: oDataService,
				...
				success: function (oData) {
					...
					if (oData.result && oData.result[0]) { //.length > 0
						for (var idx in oData.result) {
							...
							if (!this.sID) {
								this.sID = obj.u_bcp_correlation_id || obj["source_record.correlation_id"]; //obj["source_record.number"];
								this.checkForOpenEscalation(); // temporariry 
								//this.afterGetPointer();
							}

							var firstCaseFeedItem = {
								text: obj["source_record.description"] + "\n" + obj["source_record.short_description"],
								user_name: obj["source_record.sys_created_by"],
								created_on: obj["source_record.sys_created_on"]
							};

							sData = {
								"ID": obj.u_bcp_correlation_id,
								"SNow_number": obj["source_record.number"],
								"ShortID": obj["source_record.correlation_display"], //002075129500004499092019
								"Priority": obj["source_record.priority"],
								"PriorityTxt": formatter.SnowCasePriorityTxt(obj["source_record.priority"]),
								"CustomerName": obj["source_record.account.name"],
								"CustomerNo": obj["source_record.account.number"],
								"Contract_Type": formatter.formatContractDes(obj["source_record.u_contract_type_list"]),
								"StatusTxt": formatter.SnowCaseStatusTxt(obj["source_record.state"]) + " / " + formatter.getCimActionStatus(obj[
									"source_record.action_status"]),
								"Escalation": obj["source_record.escalation"], //I338673 case level or esc level?
								"ComponentName": obj["source_record.u_app_component.u_name"],
								"PROCESSOR_ORG": obj["source_record.assignment_group.name"], //incident/case level
								"Processor": obj["source_record.assigned_to.name"],
								"ExpectedAction": obj["u_expected_action"],
								/*!== "" ? obj["source_record.assigned_to.name"] + " (" + obj[
									"source_record.assigned_to.user_name"] + ")" : ""*/
								"Instno": formatter.trimPreZeros(obj["source_record.u_deployed_item.u_number"]),
								"SysID": obj["source_record.u_deployed_item.u_sid"], //obj.sys_id,//
								"business_impact": obj["source_record.business_impact"], //obj.business_impact, 
							...
							case "0":
								...
								this.getModel("BDMRequest").setProperty("/escalationCaseId", obj["source_record.number"]);
								this.getModel("BDMRequest").setProperty("/escalationCaseComponent", obj["source_record.u_app_component.u_name"]);
								this.getModel("BDMRequest").setProperty("/escalationCaseAssignmentGroup", obj["source_record.assignment_group.name"]);
								this.getModel("BDMRequest").setProperty("/escalationCaseCustomerId", obj["source_record.account.number"]);
								this.getModel("BDMRequest").setProperty("/escalationCaseCustomerName", obj["source_record.account.name"]);
								...
								//source_record.assignment_group.name
							...
							case "3":
								...
								this.getModel("CIMRequest").setProperty("/escalationCaseId", obj["source_record.number"]);
								this.getModel("CIMRequest").setProperty("/escalationCaseComponent", obj["source_record.u_app_component.u_name"]);
								this.getModel("CIMRequest").setProperty("/escalationCaseAssignmentGroup", obj["source_record.assignment_group.name"]);
								this.getModel("CIMRequest").setProperty("/escalationCaseCustomerId", obj["source_record.account.number"]);
								this.getModel("CIMRequest").setProperty("/escalationCaseCustomerName", obj["source_record.account.name"]);
						...
						this.CustomerNo = obj["source_record.account.number"];
						this.CustomerName = obj["source_record.account.name"];
						...
						if (obj["source_record.u_responsible_party"] === "bcp") { //leading system bcp
		...
		_loadSamService: function () {
			if (!sap.support.fsc2.oDataW71Model) {
				...
				sap.support.fsc2.oDataW71Model = new sap.ui.model.odata.v2.ODataModel("/w71/sap/opu/odata/SVT/NGMSG_WEBSERVICES_SRV/", {
					json: true,
					useBatch: false
				});
				sap.support.fsc2.oDataW72Model = new sap.ui.model.odata.v2.ODataModel("/w72/sap/opu/odata/SVT/NGMSG_WEBSERVICES_SRV/", {
					json: true,
					useBatch: false
				});
			}
		...
		SamCheck: function (sIncidentNum, attempt) {
			...
			var serviceUrl = attempt === 1 ? "/w71/odata/incidentws/" : "/w72/odata/incidentws/";
		...
		checkForOpenEscalation: function (sValue) {
			this.getView().setBusy(true);
			var oDataService = {
				"sysparm_fields": "action_status,source_record.correlation_id,source_record.action_status,de_escalation_justification,escalation_justification,u_request_reason,u_escalation_type,source_record.description,source_record.sys_created_on,source_record.sys_created_by,u_request,source_record.account.number,assigned_to.name,u_expected_action,u_business_impact,source_record.number,source_record.u_responsible_party,u_responsible_party,state,source_record.short_description,source_record.business_impact,source_record.u_contract_type_list,source_record.priority,source_record.account.name,source_record.u_deployed_item.u_number,source_record.u_deployed_item.u_sid, requested_by.name,requested_by.employee_number,requested_by.department.name,number,u_short_description,active,number,u_bcp_correlation_id,sys_updated_by,escalation,sys_id,short_description,source_record.correlation_display,priority,source_record.state,source_record.u_app_component.u_name,source_record.assigned_to.user_name,assigned_to.email,source_record.assigned_to.name,source_record.assignment_group.name,u_last_user_updated_on,u_next_action_due,sys_created_on"
			};
