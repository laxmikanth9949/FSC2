				...
				success: function (oData) {
					...
					oData.result.forEach(function (x) {
						aData.push({
							...
							"ID": x["u_task_record.ref_sn_customerservice_case.correlation_display"],
