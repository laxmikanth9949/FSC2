sap.ui.define(
	...
	function (models) {
		...
		return {
			...
			if (currentUrl.includes("kinkajou") || currentUrl.includes("test-004") || currentUrl.includes("sapitcloudt")) {
				//we are in test environment
					url = "https://sapit-home-test-004.launchpad.cfapps.eu10.hana.ondemand.com/site#mccsos-Display&/";
			} else if (currentUrl.includes("mallard") || currentUrl.includes("dev-004") || currentUrl.includes("br339jmc4c")) {
				//we are in dev environment
				url = "https://sapit-customersupport-dev-mallard.launchpad.cfapps.eu10.hana.ondemand.com/site?siteId=36ff2be6-ee6a-43ad-bd90-163ba46cbfa9#mccsos-Display&/";
			} else if (currentUrl.includes("kestrel") || currentUrl.includes("prod-004") || currentUrl.includes("sapitcloud")) {
				url = "https://sapit-home-prod-004.launchpad.cfapps.eu10.hana.ondemand.com/site#mccsos-Display&/";
			}else {
				url = "https://launchpad.one.int.sap/site#mccsos-Display&/";	
			}
			return url;
		},
